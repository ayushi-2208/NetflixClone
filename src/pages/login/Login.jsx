    ...
    <div className="login">
      ...
      <div className="container">
        <form>
          ...
          <button className="loginButton" disabled={submitButtonDisabled} onClick={handleSubmission}>Sign In</button>
          <span>
            New to Netflix? <Link to="/signup" className="signups"><b>Sign up now.</b></Link>
          </span>
          <small>
